...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_BASE, 'projectboard.db'),                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(PROJECT_BASE, 'assets')
...
if DEBUG:
    ...
    def codebase_id():
        """
        returns a string which uniquely identify the codebase
        """
        import subprocess
        p = subprocess.Popen(
    ...
    STATIC_URL = '/assets/%s/' % codebase_id()
